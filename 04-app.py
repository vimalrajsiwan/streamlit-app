...
# Interview stage  --when setup_complete && !chat_complete && !feedback_shown
...
if st.session_state.feedback_shown:
    ...
    # Initialize new OpenAI client instance for feedback --updated
    ...
    # st.markdown(feedback_completion)
